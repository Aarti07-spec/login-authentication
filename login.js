...
let loginPasswordErrorMessageEl = document.getElementById(
  "loginPasswordErrorMessage"
);
let alreadyExistErrorMessageEl = document.getElementById(
...
let registerPasswordErrorMessageEl = document.getElementById(
...
function register() {
  ...
  if (!username) {
    ...
    registerPasswordErrorMessage.textContent =
      "Please enter an alphanumeric password of at least 8 characters.";
